...
public class ObjectFactory {
    ...
    private final static QName _CreateTimeSeriesIdentifier_QNAME = new QName("http://tempuri.org/", "identifier");
    ...
    public JAXBElement<String> createCreateTimeSeriesIdentifier(String value) {
        return new JAXBElement<String>(_CreateTimeSeriesIdentifier_QNAME, String.class, CreateTimeSeries.class, value);
    }
    ...
    public JAXBElement<String> createGetTimeSeriesIDIdentifier(String value) {
        return new JAXBElement<String>(_CreateTimeSeriesIdentifier_QNAME, String.class, GetTimeSeriesID.class, value);
    }
    ...
    public JAXBElement<String> createUndoAppendIdentifier(String value) {
        return new JAXBElement<String>(_CreateTimeSeriesIdentifier_QNAME, String.class, UndoAppend.class, value);
    }
    ...
    public JAXBElement<String> createGetTimeSeriesID2Identifier(String value) {
        return new JAXBElement<String>(_CreateTimeSeriesIdentifier_QNAME, String.class, GetTimeSeriesID2 .class, value);
    }
